...
QUERY_FEATURE=subset_v2_feature
GALLERY_FEATURE=subset_v2_feature
...
CUDA_VISIBLE_DEVICES=0 python extract_features.py \
 ...
 --audio_file_dir /multi_modal/data/audios \
 --split test \
 --train_batch_size 32 \
 --max_seq_length 36 \
 --zero_shot \
...
# --bert_model bert-base-chinese \
# --from_pretrained ../save/${MODEL_TYPE}/pytorch_model_9.bin \
# --config_file ../../../config/bert_base_6layer_6conect_capture_itpv.json \
# --predict_feature \
# --split test \
# --train_batch_size 32 \
# --max_seq_length 100 \
# --zero_shot \
# --lmdb_file /multi_modal/data/lmdb_features/${QUERY_FEATURE}.lmdb \
# --caption_path /multi_modal/data/product5m_v2/product1m_product5m_test_id_label.json \
# --feature_dir ./feature_data/${MODEL_TYPE}/${QUERY_FEATURE}/return_hidden \
# --return_hidden
...
python eval_spearman.py \
  --query_feature_path ${QUERY_FEATURE_DIR} \
  --gallery_feature_path ${GALLERY_FEATURE_DIR} \
  --retrieval_results_path ${OUTPUT_METRIC_DIR}
