...
class Conceptual_Caption(RNGDataFlow):
    ...
    def __init__(self, corpus_path, shuffle=False):
        ...
        file_name_list=[
            ...
            "gallery_c_60_75.tsv",
            "gallery_c_75_90.tsv",
            "gallery_c_90_105.tsv",
            "gallery_c_105_120.tsv"
        ]

        self.infiles = ["{}/{}".format("/multi_modal/data/tsv_features/gallery_c",i) for i in file_name_list]
        self.counts = []
        # self.num_caps = 3136161
        # self.num_caps = 15027 + 113970 # TODO: modify each time
        self.num_caps = 1179613
...
if __name__ == '__main__':
    ...
    LMDBSerializer.save(ds1, '/multi_modal/data/lmdb_features/gallery_c_feature.lmdb')
