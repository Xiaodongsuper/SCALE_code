...
class Conceptual_Caption(RNGDataFlow):
    ...
    def __init__(self, corpus_path, shuffle=False):
        ...
        self.ava_ids=list(read_json("/multi_modal/data/product5m_v2/subset_v4_test_id_label.json").keys())
...
if __name__ == '__main__':
    ...
    LMDBSerializer.save(ds1, '/multi_modal/data/lmdb_features/subset_v4_test_feature.lmdb')
