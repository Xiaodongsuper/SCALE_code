...
class Conceptual_Caption(RNGDataFlow):
    ...
    def __init__(self, corpus_path, shuffle=False):
        ...
        self.ava_ids=list(read_json("/multi_modal/data/product5m_v2/subset_v4_train_id_label.json").keys())
        ...
        self.num_caps = len(self.ava_ids)
            ...
            with open(infile) as tsv_in_file:
                ...
                for item in reader:
                    ...
                    try:
                        ...
                        if image_id not in self.ava_ids: continue
...
if __name__ == '__main__':
    ...
    LMDBSerializer.save(ds1, '/multi_modal/data/lmdb_features/subset_v4_train_feature.lmdb')
